...
for i in fusionpbx-core fusionpbx-provisioning-template-aastra fusionpbx-provisioning-template-cisco fusionpbx-provisioning-template-grandstream \
		...
		fusionpbx-app-edit fusionpbx-app-exec fusionpbx-app-extensions fusionpbx-app-fax fusionpbx-app-fifo fusionpbx-app-fifo-list fusionpbx-app-follow-me \
		fusionpbx-app-gateways fusionpbx-app-hot-desking fusionpbx-app-ivr-menu fusionpbx-app-login fusionpbx-app-log-viewer fusionpbx-app-meetings \
		fusionpbx-app-modules fusionpbx-app-music-on-hold fusionpbx-app-park fusionpbx-app-provision fusionpbx-app-recordings fusionpbx-app-registrations \
		fusionpbx-app-ring-groups fusionpbx-app-schemas fusionpbx-app-services fusionpbx-app-settings fusionpbx-app-sip-profiles fusionpbx-app-sip-status \
		fusionpbx-app-sql-query fusionpbx-app-system fusionpbx-app-time-conditions fusionpbx-app-traffic-graph fusionpbx-app-vars fusionpbx-app-voicemail-greetings \
		fusionpbx-app-voicemails fusionpbx-app-xml-cdr fusionpbx-app-xmpp
